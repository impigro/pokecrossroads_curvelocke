...
#define I_EXP_SHARE_FLAG        FLAG_UNUSED_0x020  // Curvelocke Rule 3: flag toggled by the EXP SHARE entry in the Options menu (default ON for new games). When set, every party Pokémon gains experience.
